...
namespace App\Filament\Resources\StoreTransactions\RelationManagers;
...
class ChatsRelationManager extends RelationManager
{
    ...
    protected static ?string $title = 'Tin nhắn giao dịch cửa hàng';
    ...
    public static function getTabComponent(Model $ownerRecord, string $pageClass): Tab
    {
        ...
        return Tab::make('Tin nhắn')
            ->badge($chatCount)
            ->badgeColor($chatCount > 0 ? 'info' : 'gray')
        ...
        return $schema
            ->components([
                ...
                FileUpload::make('images')
                    ...
                    ->directory('store-transaction-chats/images')
                    ->columnSpanFull(),
                ...
                FileUpload::make('files')
                    ...
                    ->directory('store-transaction-chats/files')
                    ->columnSpanFull(),
            ]);
    }
        ...
        return $table
            ...
            ->columns([
                ...
                BadgeColumn::make('attachments')
                    ...
                    ->colors([
                        'info' => fn ($record) => $record->hasAttachments(),
                    ])
            ...
            ->emptyStateDescription('Bắt đầu cuộc trò chuyện về sản phẩm và giao dịch.')
